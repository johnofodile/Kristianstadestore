...
export const FilterBar = ({ onClose }) => {
          ...
          <ul className="text-slate-700 dark:text-slate-100">
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input  onChange={() => dispatch({type:"SORT_BY", payload:{sortBy:"lowToHigh"}})}  checked={state.sortBy === "lowToHigh" || false}
                  id="price-sort-1"
                  type="radio"
                  value=""
                  name="price-sort"
              ...
              <div className="flex items-center my-1">
                <input onChange={() => dispatch({type:"SORT_BY", payload:{sortBy:"highToLow"}})}  checked={state.sortBy === "highToLow" || false}
                  id="price-sort-2"
                  type="radio"
                  value=""
                  name="price-sort"
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input  onChange={() => dispatch({type:"RATINGS", payload:{ratings:"4STARSABOVE"}})}  checked={state.ratings === "4STARSABOVE" || false}
                  id="rating-sort-1"
                  type="radio"
                  value=""
                  name="rating-sort"
              ...
              <div className="flex items-center my-1">
                <input onChange={() => dispatch({type:"RATINGS", payload:{ratings:"3STARSABOVE"}})}  checked={state.ratings === "3STARSABOVE" || false}
                  id="rating-sort-2"
                  type="radio"
                  value=""
                  name="rating-sort"
              ...
              <div className="flex items-center my-1">
                <input onChange={() => dispatch({type:"RATINGS", payload:{ratings:"2STARSABOVE"}})}  checked={state.ratings === "2STARSABOVE" || false}
                  id="rating-sort-3"
                  type="radio"
                  value=""
                  name="rating-sort"
              ...
              <div className="flex items-center my-1">
                <input onChange={() => dispatch({type:"RATINGS", payload:{ratings:"1STARSABOVE"}})}  checked={state.ratings === "1STARSABOVE" || false}
                  id="rating-sort-4"
                  type="radio"
                  value=""
                  name="rating-sort"
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                {/* //payload is the value we pass to update our state */}
                {/* bestselleronly below comes from the initial state in the contect filter file */}
                <input
                  onChange={() =>
                    dispatch({
            ...
            <li className="mt-1 mb-5 px-1">
              <button onClick={() => dispatch({type:"CLEAR_FILTER", payload: {onlyInStock:false, bestSellerOnly: false, sortBy: null, ratings: null}})}  checked={state.ratings === "1STARSABOVE" || false}
                type="button"
